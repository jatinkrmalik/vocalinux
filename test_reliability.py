...
class MockAudioDevice:
    ...
    def read(self, chunk_size, exception_on_overflow=False):
        ...
        if (
            self.fail_after
            and current_time - self.start_time > self.fail_after
        ...
        if self.is_failed and current_time - self.fail_start_time > self.fail_duration:
            self.is_failed = False
...
def test_audio_buffer_limits():
    ...
    try:
        ...
        _ = len(manager.audio_buffer)  # Initial size for reference
