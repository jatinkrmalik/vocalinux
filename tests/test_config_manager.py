...
class TestConfigManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_dir_patcher = patch('src.ui.config_manager.CONFIG_DIR', self.temp_config_dir)
        self.config_file_patcher = patch('src.ui.config_manager.CONFIG_FILE', self.temp_config_file)
    ...
    def test_init_default_config(self):
        ...
        self.mock_logger.info.assert_called_with(f"Config file not found at {self.temp_config_file}. Using defaults.")
    ...
    def test_load_config(self):
        ...
        self.assertEqual(config_manager.config["recognition"]["auto_punctuate"], True)  # From defaults
