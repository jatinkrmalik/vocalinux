...
class TestKeyboardShortcuts(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(modifiers, {self.mock_keyboard.Key.alt, self.mock_keyboard.Key.shift})
    ...
    def test_normalize_modifier_keys(self):
        ...
        self.ksm._normalize_modifier_key = MagicMock(side_effect=lambda key: {
    ...
    def test_key_release(self):
        ...
        # Add some keys
        self.ksm.current_keys = {self.mock_keyboard.Key.ctrl, self.mock_keyboard.Key.alt}
