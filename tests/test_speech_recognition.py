...
class TestSpeechRecognition(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher_cmd = patch('src.speech_recognition.recognition_manager.CommandProcessor')
        ...
        self.patcher_thread = patch('src.speech_recognition.recognition_manager.threading.Thread')
        ...
        self.patcher_play_start = patch('src.speech_recognition.recognition_manager.play_start_sound')
        self.mock_play_start = self.patcher_play_start.start()
        
        self.patcher_play_stop = patch('src.speech_recognition.recognition_manager.play_stop_sound')
        self.mock_play_stop = self.patcher_play_stop.start()
        
        self.patcher_play_error = patch('src.speech_recognition.recognition_manager.play_error_sound')
    ...
    def test_process_final_buffer_whisper(self):
        ...
        with patch('tempfile.mkstemp', return_value=(5, '/tmp/tmpfile.wav')), \
             patch('wave.open', return_value=MagicMock()), \
             patch('os.unlink'):
