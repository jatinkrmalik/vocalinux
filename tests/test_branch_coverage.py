...
class TestRecognitionManagerInit:
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
...
class TestRecognitionManagerModelReady:
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_model_ready_false_when_not_initialized(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_model_ready_true_when_initialized(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
...
class TestRecognitionManagerSilenceTimeout:
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_reconfigure_silence_timeout_clamp_min(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_reconfigure_silence_timeout_clamp_max(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_reconfigure_vad_sensitivity_clamp_min(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_reconfigure_vad_sensitivity_clamp_max(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
...
class TestRecognitionManagerVoiceCommands:
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_reconfigure_voice_commands_enabled(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
...
class TestRecognitionManagerUpdateState:
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_update_state_triggers_callbacks(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
...
class TestRecognitionManagerInitOptions:
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_init_with_voice_commands_disabled(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
...
class TestCallbackManagement:
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_unregister_nonexistent_callback(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
    ...
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whisper')
    @patch('vocalinux.speech_recognition.recognition_manager.SpeechRecognitionManager._init_whispercpp')
    def test_unregister_audio_level_nonexistent(self, mock_init_cpp, mock_init_whisper, mock_init_vosk):
