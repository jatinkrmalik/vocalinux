...
class TestListGpuDevices(unittest.TestCase):
    ...
    def test_get_whispercpp_compiled_backends_defaults_to_cpu_without_module(self):
        import builtins
        ...
        with patch("builtins.__import__", side_effect=import_side_effect):
            ...
            assert get_whispercpp_compiled_backends() == {ComputeBackend.CPU}

    def test_get_whispercpp_compiled_backends_defaults_to_cpu_without_module_file(self):
        from types import ModuleType
    ...
    def test_get_whispercpp_compiled_backends_defaults_to_cpu_without_libs_dir(self):
        from pathlib import Path
        from tempfile import TemporaryDirectory
        from types import ModuleType

        with TemporaryDirectory() as root:
            package_dir = Path(root) / "pywhispercpp"
            package_dir.mkdir()
