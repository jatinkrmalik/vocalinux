...
class TestEnvironmentManager(unittest.TestCase):
    ...
    def test_detect_features_production(self, mock_gui, mock_keyboard, mock_audio, mock_env):
    ...
    def test_can_access_audio_hardware(self, mock_which):
        ...
        with patch("subprocess.run") as mock_run:
            ...
            with patch("os.path.exists", return_value=False):
                ...
                with patch.object(manager, "_can_access_audio_hardware", return_value=False):
