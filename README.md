...
- **Remote API speech recognition engine** — Configure Vocalinux to use compatible remote transcription services, including whisper.cpp, OpenAI-compatible FunASR/SenseVoice, and chat-completions audio servers, while keeping existing local engines available (#335, #468)
