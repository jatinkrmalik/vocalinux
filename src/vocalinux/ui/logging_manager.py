...
class LogRecord:
    ...
    def __init__(self, timestamp: datetime, level: str, logger_name: str, message: str, module: str = ""):
...
class LoggingManager:
    ...
    def get_logs(self, level_filter: Optional[str] = None, 
                 ...
                 last_n: Optional[int] = None) -> List[LogRecord]:
        """
    ...
    def export_logs(self, filepath: str, level_filter: Optional[str] = None,
                   module_filter: Optional[str] = None) -> bool:
        """
    ...
    def get_log_stats(self) -> dict:
        ...
        by_module = {}
        for record in records:
            module = record.logger_name.split('.')[0] if '.' in record.logger_name else record.logger_name
