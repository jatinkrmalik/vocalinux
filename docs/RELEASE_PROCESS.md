...
| 0.15.0 | 2026-07-28 | Stable | Searchable settings, AppImage, expanded languages (Hungarian+), dictation capitalize/spacing, auto-pause/keepalive, Vulkan device selection, ibus-wayland, Bluetooth mic crash fix |
